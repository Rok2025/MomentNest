...
beforeAll(async()=>{
 ...
 await db.exec(readFileSync(new URL('../supabase/migrations/20260910075100_add_media_time_review_flag.sql',import.meta.url),'utf8'));await db.exec(readFileSync(new URL('../supabase/migrations/20260910123000_raise_video_limit_to_1gb.sql',import.meta.url),'utf8'));
