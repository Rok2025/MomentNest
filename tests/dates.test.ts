...
import { ageOn,agePartsOn,shortAgeOn,todayShanghai,validEventDate } from '../src/domain/dates';
...
describe('北京时间与成长日期',()=>{
 ...
 it('年龄卡使用同一份年、月、日计算结果',()=>expect(agePartsOn('2026-09-08')).toEqual({years:1,months:4,days:22}));
