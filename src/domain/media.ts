...
export type MediaRecord={id:string;eventId:string;filename:string;kind:MediaKind;mime:string;size:number;position:number;status:'pending'|'processing'|'ready'|'failed';needsTimeReview?:boolean;capturedText:string|null;capturedZone:string|null;captureTimeOverride?:string|null;errorCode:string|null;hasPreview:boolean;hasPlayback:boolean;preview?:PreviewLinks;playback?:PlaybackLink};
