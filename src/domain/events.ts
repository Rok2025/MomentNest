...
export type EventRecord = { id: string; title: string; body: string; feeling: string; occurredOn: string; createdAt: string; updatedAt: string; author: string; editor: string; version: number; mediaCount:number; imageCount:number; videoCount:number; coverMediaId:string|null;cover?:MediaRecord|null;media?:MediaRecord[] };
